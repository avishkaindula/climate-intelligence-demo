  ...
  const featuredMissions = [
    {
      ...
      description: "Help map temperature variations in your city to identify heat hotspots",
    ...
    },
    {
      ...
      description: "Document local flora and fauna to track climate impact on ecosystems",
  ...
  const campaigns = [
    {
      ...
      description: "Join the fight against deforestation in the Amazon rainforest",
                ...
                <VStack space="xs" className="flex-1">
                  ...
                  <Box className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full mt-1">
                    <Box 
                      ...
                      style={{
                        width: `${(userStats.currentPoints / userStats.nextLeagueThreshold) * 100}%`,
                  ...
                  <Card key={campaign.id} className="w-80 h-48 overflow-hidden relative">
                    ...
                    <Box className="absolute bottom-0 left-0 right-0 p-4">
                      <VStack space="md">
                        ...
                        <Button size="sm" variant="solid" className="bg-white/20 border-white/40">
                ...
                {rewards.map((reward) => (
                  <Card key={reward.id} className="w-48 p-4">
                    <VStack space="md" className="items-center">
                      ...
                      >
                        <Text className={userStats.currentPoints >= reward.points 
                          ? "text-primary-500" 
                          : "text-gray-400"
                        }>
                          Redeem
